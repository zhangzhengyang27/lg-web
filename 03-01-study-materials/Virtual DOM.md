...
- 为了简化 DOM 的复杂操作于是出现了各种 MVVM 框架，MVVM 框架解决了视图和状态的同步问题（视图发生变化更新数据，数据发生变化更新视图）
...
- 维护视图和状态的关系（记录上一次的变化，只更新新增的数据）

- **复杂视图情况下提升渲染性能**

- 除了渲染 DOM 以外，还可以实现 SSR(Nuxt.js/Next.js)、原生应用(Weex/React Native)、小程序(mpvue/uni-app)等

   <img src="https://interview-aliyun.oss-cn-beijing.aliyuncs.com/myBlog/image-20200102104642121.png" alt="image-20200102104642121" style="zoom:50%;" />

##  Virtual DOM 库

- [Snabbdom](https://github.com/snabbdom/snabbdom)
  - Vue 2.x 内部使用的 Virtual DOM 就是改造的 Snabbdom
  - 大约 200 SLOC（single line of code）源码只有200行
  - 通过模块可扩展
  - 源码使用 TypeScript 开发
  - 最快的 Virtual DOM 之一
...
- 对比新旧 VNode 是否相同节点(节点的 key 和 sel 相同(节点选择器))
- 如果不是相同节点，删除之前的内容，重新渲染
- 如果是相同节点，再判断新的 VNode 是否有 text，如果有并且和 oldVnode 的 text 不同，直接更新文本内容
- 如果新的 VNode 有 children，判断子节点是否有变化，判断子节点的过程使用的就是 diff 算法
- diff 过程只进行同层级比较

![image-20200102103653779](https://interview-aliyun.oss-cn-beijing.aliyuncs.com/myBlog/image-20200102103653779.png)
...
- **执行过程：**
  ...
  ![image-20200102103653779.png](https://interview-aliyun.oss-cn-beijing.aliyuncs.com/myBlog/image-20200102103653779.png)
  ...
  ![image-20200109184608649](https://interview-aliyun.oss-cn-beijing.aliyuncs.com/myBlog/image-20200109184608649.png)
  ...
  ![image-20200103121812840](https://interview-aliyun.oss-cn-beijing.aliyuncs.com/myBlog/image-20200103121812840.png)
  ...
  ![image-20200103125428541](https://interview-aliyun.oss-cn-beijing.aliyuncs.com/myBlog/image-20200103125428541.png)
  ...
  ![image-20200103125735048](https://interview-aliyun.oss-cn-beijing.aliyuncs.com/myBlog/image-20200103125735048.png)
  ...
  ![image-20200109184822439](https://interview-aliyun.oss-cn-beijing.aliyuncs.com/myBlog/image-20200109184822439.png)
  ...
  ![image-20200103150918335](https://interview-aliyun.oss-cn-beijing.aliyuncs.com/myBlog/image-20200103150918335.png)

  ​	

    - 如果新节点的数组先遍历完(newStartIdx > newEndIdx)，说明老节点有剩余，把剩余节点批量删除

  ![image-20200109194751093](https://interview-aliyun.oss-cn-beijing.aliyuncs.com/myBlog/image-20200109194751093.png)
...
![image-20200112120036948](https://interview-aliyun.oss-cn-beijing.aliyuncs.com/myBlog/image-20200112120036948.png)
